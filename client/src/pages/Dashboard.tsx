    ...
    return (
        <div className="pt-4 pb-20 max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                {/* Level Card */}
                <div className="bg-[var(--color-text)] text-white p-10 relative overflow-hidden group min-h-[450px] flex flex-col justify-between border border-[var(--color-text)] shadow-brutal-sm rounded-lg">
                ...
                {/* Chart Section */}
                <div className="border border-[var(--color-surface)] p-10 bg-white min-h-[450px] flex flex-col shadow-brutal-sm rounded-lg">
